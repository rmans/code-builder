...
def commands_list(output_format, status):
    """List available commands from .cb/commands/ directory."""
    import yaml
    import os
    from pathlib import Path
    ...
    if output_format == 'json':
        ...
        click.echo(json.dumps(commands, indent=2, default=json_serializer))
...
def commands_show(command_name, output_format):
    ...
    try:
        ...
        if output_format == 'metadata':
            ...
            click.echo(json.dumps(cmd_data, indent=2, default=json_serializer))
