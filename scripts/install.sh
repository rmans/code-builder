...
setup_commands() {
    ...
    # Create basic command templates (stubs for now)
    echo "Creating analyze-project command template..."
    cat > .cb/engine/templates/commands/analyze-project.md << 'EOF'
---
id: analyze-project
...
EOF
    ...
    echo "Creating plan-project command template..."
    cat > .cb/engine/templates/commands/plan-project.md << 'EOF'
---
id: plan-project
title: Plan Project
...
EOF
    ...
    cp .cb/engine/templates/commands/analyze-project.md .cb/commands/
    cp .cb/engine/templates/commands/plan-project.md .cb/commands/
